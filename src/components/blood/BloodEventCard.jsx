...
//     try {
//       const donationData = {
//         event: event.id,  // Correct: send event id
//         units_donated: 1
//       };
...
//             'You have already donated to this request/event.';
...
//               {hasAccepted ? (
//                 <span className="inline-flex items-center px-4 py-2 rounded-md bg-green-100 text-green-800 font-medium">
//                   Already Accepted
//                 </span>
//               ) : (
//                 <button
...
//           errorMessage = 'Please login to donate.';
//         } else if (error.response.data) {
//           // Handle other potential error messages from backend
//           errorMessage = error.response.data.message || errorMessage;
//         }
//       }
...
//                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
//               </svg>
//               <span>Created by: <span className="font-medium">{event.creator?.name || event.creator?.email}</span></span>
//             </div>
